...
const (
	DaemonPlugin_ReportCommand_FullMethodName = "/proto.DaemonPlugin/ReportCommand"
	DaemonPlugin_Metacommand_FullMethodName   = "/proto.DaemonPlugin/Metacommand"
	DaemonPlugin_Info_FullMethodName          = "/proto.DaemonPlugin/Info"
	DaemonPlugin_Init_FullMethodName          = "/proto.DaemonPlugin/Init"
)
...
type DaemonPluginClient interface {
	...
	Init(ctx context.Context, in *PluginConfig, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *daemonPluginClient) ReportCommand(ctx context.Context, in *ReportCommandRequest, opts ...grpc.CallOption) (*Empty, error) {
	...
	out := new(Empty)
	err := c.cc.Invoke(ctx, DaemonPlugin_ReportCommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonPluginClient) Metacommand(ctx context.Context, in *MetacommandRequest, opts ...grpc.CallOption) (*MetacommandResponse, error) {
	...
	err := c.cc.Invoke(ctx, DaemonPlugin_Metacommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonPluginClient) Info(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PluginInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PluginInfo)
	err := c.cc.Invoke(ctx, DaemonPlugin_Info_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonPluginClient) Init(ctx context.Context, in *PluginConfig, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, DaemonPlugin_Init_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonPluginServer interface {
	...
	Init(context.Context, *PluginConfig) (*Empty, error)
...
func (UnimplementedDaemonPluginServer) Init(context.Context, *PluginConfig) (*Empty, error) {
...
func _DaemonPlugin_ReportCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonPlugin_ReportCommand_FullMethodName,
	}
...
func _DaemonPlugin_Metacommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonPlugin_Metacommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DaemonPlugin_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonPlugin_Info_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DaemonPlugin_Init_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PluginConfig)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonPluginServer).Init(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonPlugin_Init_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonPluginServer).Init(ctx, req.(*PluginConfig))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DaemonPlugin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Init",
			Handler:    _DaemonPlugin_Init_Handler,
		},
	},
