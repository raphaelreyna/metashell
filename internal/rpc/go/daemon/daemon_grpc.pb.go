...
const (
	ShellclientDaemon_PreRunQuery_FullMethodName   = "/metashell.daemon.ShellclientDaemon/PreRunQuery"
	ShellclientDaemon_PostRunReport_FullMethodName = "/metashell.daemon.ShellclientDaemon/PostRunReport"
)
...
func (c *shellclientDaemonClient) PreRunQuery(ctx context.Context, in *PreRunQueryRequest, opts ...grpc.CallOption) (*PreRunQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShellclientDaemon_PreRunQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shellclientDaemonClient) PostRunReport(ctx context.Context, in *PostRunReportRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, ShellclientDaemon_PostRunReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ShellclientDaemon_PreRunQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShellclientDaemon_PreRunQuery_FullMethodName,
	}
...
func _ShellclientDaemon_PostRunReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShellclientDaemon_PostRunReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ShellclientDaemon_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "metashell.daemon.ShellclientDaemon",
...
const (
	MetashellDaemon_NewExitCodeStream_FullMethodName    = "/metashell.daemon.MetashellDaemon/NewExitCodeStream"
	MetashellDaemon_RegisterCommandEntry_FullMethodName = "/metashell.daemon.MetashellDaemon/RegisterCommandEntry"
	MetashellDaemon_Metacommand_FullMethodName          = "/metashell.daemon.MetashellDaemon/Metacommand"
	MetashellDaemon_GetPluginInfo_FullMethodName        = "/metashell.daemon.MetashellDaemon/GetPluginInfo"
)
...
func (c *metashellDaemonClient) NewExitCodeStream(ctx context.Context, in *Empty, opts ...grpc.CallOption) (MetashellDaemon_NewExitCodeStreamClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MetashellDaemon_ServiceDesc.Streams[0], MetashellDaemon_NewExitCodeStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &metashellDaemonNewExitCodeStreamClient{ClientStream: stream}
...
func (c *metashellDaemonClient) RegisterCommandEntry(ctx context.Context, in *CommandEntry, opts ...grpc.CallOption) (*CommandKey, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommandKey)
	err := c.cc.Invoke(ctx, MetashellDaemon_RegisterCommandEntry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metashellDaemonClient) Metacommand(ctx context.Context, in *MetacommandRequest, opts ...grpc.CallOption) (*MetacommandResponse, error) {
	...
	err := c.cc.Invoke(ctx, MetashellDaemon_Metacommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metashellDaemonClient) GetPluginInfo(ctx context.Context, in *GetPluginInfoRequest, opts ...grpc.CallOption) (*GetPluginInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, MetashellDaemon_GetPluginInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetashellDaemon_NewExitCodeStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MetashellDaemonServer).NewExitCodeStream(m, &metashellDaemonNewExitCodeStreamServer{ServerStream: stream})
}
...
func _MetashellDaemon_RegisterCommandEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetashellDaemon_RegisterCommandEntry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MetashellDaemon_Metacommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetashellDaemon_Metacommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MetashellDaemon_GetPluginInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetashellDaemon_GetPluginInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var MetashellDaemon_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "metashell.daemon.MetashellDaemon",
